...
public class Login extends javax.swing.JFrame {
    ...
    private void loginButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_loginButtonMouseClicked
        try{
            Connection koneksi = (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/tsr-pos","root","");
            ...
            if (rs.next()){
                nameLog.setText(rs.getString(4));
            }
            ...
            if(txtuser.getText().equals("username") && txtpass.getText().equals("password") && 
                ...
                JOptionPane.showMessageDialog(null, "Login Gagal ! Username, Password / Hak Akses Salah !");
            }
